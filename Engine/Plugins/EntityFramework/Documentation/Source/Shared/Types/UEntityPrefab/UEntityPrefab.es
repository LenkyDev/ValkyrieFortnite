...
[VAR:ToolTipOverride]
Un recurso prefabricado es una plantilla reutilizable para una entidad. 
Puedes personalizar su comportamiento añadiendo componentes y ampliarla agregando entidades hijo.
Asimismo, puedes arrastrar y soltar tantas instancias del prefabricado como desees en tus niveles
y personalizar cada instancia por separado. Los cambios que realices posteriormente en el recurso prefabricado
se aplicarán automáticamente también a las instancias.
